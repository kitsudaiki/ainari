...
// GenerateSecret creates a new secret with a payload, which is generated by the server.
func GenerateSecret(context AccessContext, secretName string) (map[string]interface{}, error) {
	path := "v1alpha/secret/generate"
	jsonBody := map[string]interface{}{
		"name": secretName,
	}
	return SendPost(context, context.OmamoriAddress, path, jsonBody)
...
// GetSecretCount returns the number of secrets of the project.
func GetSecretCount(context AccessContext) (map[string]interface{}, error) {
	path := "v1alpha/secret/count"
	vars := map[string]interface{}{}
	return SendGet(context, context.OmamoriAddress, path, vars)
}
