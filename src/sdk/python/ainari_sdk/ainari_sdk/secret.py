...
def generate_secret(context: AccessContext,
                    secret_name: str) -> dict:
    """
    Creates a new secret with a payload, which is generated by the server.
    """
...
def get_secret_count(context: AccessContext) -> dict:
...
def delete_all_secrets(context: AccessContext):
    ...
    for entry in body:
        try:
            delete_secret(context, entry["uuid"])
