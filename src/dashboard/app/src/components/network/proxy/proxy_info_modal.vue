...
<template>
    <div class="modal-overlay" @click.self="cancel">
        <div class="modal proxy-info-modal">
                ...
                <table v-if="info">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ info.target_address }}</td>
                        </tr>
                        <tr>
                            <td>Virtual Machine</td>
                            <td>{{ info.virtual_machine_uuid }}</td>
                        </tr>
                        <tr>
                            <td>Created At</td>
...
const info = ref<ProxyResp | null>(null);
...
async function fetchInfo(uuid: string) {
    try {
        ...
        errorPopupMsg.value = handleAxiosError(err, "Failed to load proxy-info");
    }
}
