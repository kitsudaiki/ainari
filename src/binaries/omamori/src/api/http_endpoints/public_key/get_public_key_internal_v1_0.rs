...
#[api_operation(
    tag = "public_key",
    summary = "Get public-key (internal)",
    description = r###"Get information of a public-key from the database together with the public-key itself."###,
    error_code = 400,
    error_code = 401,
    error_code = 404,
    error_code = 500
)]
pub async fn get_public_key_internal(
    public_key_uuid: Path<Uuid>,
    context: UserContext,
) -> Result<Json<PublicKeyInternalResp>, ErrorResponse> {
    ...
    let resp = PublicKeyInternalResp {
