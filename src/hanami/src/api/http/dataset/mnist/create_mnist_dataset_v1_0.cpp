/**
 * @file        create_mnist_dataset_v1_0.cpp
 *
...
#include "create_mnist_dataset_v1_0.h"
...
CreateMnistDataSetV1M0::CreateMnistDataSetV1M0() : Blossom("Init new mnist-file dataset.")
{
    //----------------------------------------------------------------------------------------------
    // input
    //----------------------------------------------------------------------------------------------
