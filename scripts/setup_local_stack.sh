...
echo ""
echo "The two sakura-hosts (sakura on torii-vmm and sakura-2 on torii-vmm-2) register themselves"
echo "in hanami, as soon as it is up. The test waits for both of them, before it creates a"
