...
- **No strict layer structure**
    ...
    See
    [short explanation](https://docs.ainari.cloud//developerinner_workings/core/core/#no-strict-layer-structure)
    and
    [measurement-examples](https://docs.ainari.cloud/developer/inner_workings/measurements/measurements)
...
- **Spiking neural network**
    ...
    See
    [short explanation](https://docs.ainari.cloud/developer/inner_workings/core/core/#spiking-neural-network)
    and
    [measurement-examples](https://docs.ainari.cloud/developer/inner_workings/measurements/measurements)
...
- **3-dimensional networks**
    ...
    [cluster-templates](https://docs.ainari.cloud/user/cluster_templates/cluster_template/), but was
...
- **Multi-user and multi-project**
    ...
    See [Authorization-docu](https://docs.ainari.cloud/developer/inner_workings/user_and_projects/)
...
- **Installation on Kubernetes**
    ...
    See [Installation-docu](https://docs.ainari.cloud/deployer/installation/kubernetes_installation/)
